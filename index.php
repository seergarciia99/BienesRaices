      ...
      <div class="contenedor-anuncios">
        ...
        <div class="anuncio">
          ...
          <div class="contenido-anuncio">
            ...
            <p>
              Casa con alberca y acabados de lujo en la ciudad, excellente
              oportunidad
            </p>
            <p class="precio">3000000€</p>
            <ul class="iconos-caracteristicas">
    ...
    <div class="contenedor seccion seccion-inferior">
          ...
          <div class="texto-entrada">
            <a href="entrada.php">
              ...
              <p class="informacion-meta">
                Escrito el: <span>12/09/2025</span> por: <span>Admin</span>
              </p>
      ...
      <section class="testimoniales">
        ...
        <div class="testimonial">
          <blockquote>
            El personal se comportó de una forma excelente, muy buena atención y
            la casa que me frecieron cumple con todoas mis expectativas
          </blockquote>
          <p>- Sergio García</p>
        </div>
      </section>
